...
nnoremap <leader>evf :e ~/.config/vim/filetypes.vim<CR>

" Access the vim plugin configuration (edit vim plugins)
nnoremap <leader>evp :e ~/.config/vim/plugins.vim<CR>

" Access the vim helper functions (edit vim helper)
nnoremap <leader>evh :e ~/.config/vim/functions.vim<CR>
...
nnoremap <leader>eba :e ~/.config/bash/alias<CR>

" Access ~/.bash_profile
nnoremap <leader>ebp :e ~/.bash_profile<CR>

" Access bash helper functions
nnoremap <leader>ebh :e ~/.config/bash/functions<CR>
...
nnoremap <leader>ew :e ~/.config/sway/config<CR>

" Access configuration for firefox plugin tridactyl
nnoremap <leader>et :e ~/.config/tridactyl/tridactylrc<CR>

" Access the liquidprompt rc
nnoremap <leader>el :e ~/.config/liquidprompt/liquidpromptrc<CR>
